...
public class Tarea implements Serializable {
    ...
    public String marcarSubtarea(String subtarea) {
        if (subtareasCompletas.contains(subtarea)) return "La subtarea ya est� completa";
    ...
    public String desmarcarSubtarea(String subtarea) {
        if (subtareasSinCompletar.contains(subtarea)) return "La subtarea no est� completa";
