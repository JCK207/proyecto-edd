...
public class Principal {
    ...
    static List<Tarea> verTareas(List<Tarea> lista, String nombreLista) {
        ...
        String orden = "�ltima modificaci�n";
        ...
        while ((auxTareas = verTareas(lista, nombreLista))!=null) {
            ...
            while (opcion!=0 && tarea!=null) {
                ...
                switch (opcion) {
                    ...
                    case 2 -> {
                        System.out.print("Descripci�n de subtarea: ");
                        ...
                        if (subtareas.isEmpty()) {
                            ...
                            if (subtarea!=null) {
                                ...
                                switch (op) {
                                    ...
                                    case 3 -> {
                                        System.out.print("Descripci�n de la subtarea: ");
